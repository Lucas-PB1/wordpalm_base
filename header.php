		...
		<div class="collapse navbar-collapse" id="navbarSite">
			...
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
					...
					<li class="nav-item">
						<a class="nav-link" href="#"><span title="Top 10">
							<!-- Top 10 icon -->
						...
						<li class="nav-item" >
							...
							<li class="nav-item dropdown">
								<a class="nav-link dropdown" href="#" data-toogle="dropdown" id="nav-drop"><span title="Notificações">
									<!-- Notificações icon-->
									...
									<div class="dropdown-menu">
										<a class="dropdown-item" href="#">Não há notficações</a>
									</div>
								</li>
								<li class="nav-item dropdown">
